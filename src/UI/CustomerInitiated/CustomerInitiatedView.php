...
class CustomerInitiatedView extends View
{
    ...
    {
        ?>
        <h1 class="u-delta u-marg-bottom">Customer initiated journey</h1>
        ...
        <p>Test Cards:</p>
        <a href="https://stripe.com/docs/testing">All Test Cards - Stripe Docs Website</a>
        <ul class="u-list-bullets u-marg-top">
